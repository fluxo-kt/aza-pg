...
# THIS DOC IS FOR MANUAL CHANGE BY HUMAN ONLY
...
- Monitoring
  ...
  - https://github.com/NikolayS/pg_ash Active Session History for PostgreSQL — wait event sampling with zero bloat (pg_cron + PGQ-style partition rotation)
- Management
