...
3. **Current PR** (Choice 3): If no uncommitted changes, review the current PR (get it with gh CLI)
4. **Recent Commits** (Choice 3): Otherwise check the last commits and choose the logical group of last commits to review (1-5 commits; SHOULD include the last commit)
