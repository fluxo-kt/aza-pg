...
| [`pg_safeupdate`](https://github.com/eradman/pg-safeupdate)     | [1.5](https://github.com/eradman/pg-safeupdate/releases/tag/1.5)                                        | No                 | Yes            | [Docs](https://github.com/eradman/pg-safeupdate#readme)    | Guards UPDATE/DELETE without WHERE clause or LIMIT.                  |
