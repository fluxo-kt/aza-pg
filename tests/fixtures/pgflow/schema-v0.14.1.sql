...
-- Generated at: 2026-05-11T20:00:05.084Z
...
CREATE OR REPLACE FUNCTION pgflow.cleanup_ensure_workers_logs (retention_hours INTEGER DEFAULT 24) returns TABLE (cron_deleted BIGINT) language sql security definer
SET
  search_path = pgflow,
  cron,
  pg_temp AS $$
